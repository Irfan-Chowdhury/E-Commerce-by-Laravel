            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p text-center">Sub Category</th>
            ...
            <form method="post" action="{{ route('subcategory.store') }}">
              ...
              <div class="modal-body pd-20">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="subcategory_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Sub-Category">
                </div>  
