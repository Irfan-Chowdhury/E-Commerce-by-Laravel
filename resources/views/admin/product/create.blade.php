...
<!--Important- for multiple select in input field-->
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-12">
                  ...
                  <label class="form-control-label">Product Details<span class="tx-danger">*</span></label>
                   <textarea class="form-control" id="summernote" name="product_details"> <!--Editor-->
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
      				  <input type="file" id="file" class="custom-file-input" name="image_one" onchange="readURL(this);" required="" accept="image"> <!--Image Show-->
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
      				  <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL1(this);" required="" accept="image"><!--Image Show-->
      				  <span class="custom-file-control"></span>
      				  <img src="#" id="two" >
      				</label>
              </div>
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
      				  <input type="file" id="file" class="custom-file-input" name="image_three" onchange="readURL2(this);" required="" accept="/image"><!--Image Show-->
      				  <span class="custom-file-control"></span>
      				  <img src="#" id="three" >
      				</label>
              </div>
...
<!--Important these 2 script- for multiple select in input field-->
