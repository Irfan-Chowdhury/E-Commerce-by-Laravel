...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">New Post Add <a href="{{route('blog.post.index')}}" class="btn btn-success btn-sm pull-right">All Post</a></h6>
                            ...
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2" data-placeholder="Choose Category" name="post_category_id">
                                    ...
                                    @foreach($post_categories as $row)
                                        <option value="{{ $row->id }}">{{ $row->category_name_en }} | {{ $row->category_name_bn }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><!-- col-4 -->
...
{{-- </div><!-- sl-mainpanel --> --}} <!--This is in footer.blade.php-->
