    ...
    <div class="home">
        ...
        <div class="home_content d-flex flex-column align-items-center justify-content-center">
            @foreach ($subcategory as $item)
                <h2 class="home_title">Category : <span class="text-danger"> {{$item->category_name}}</span></h2>
                <h2 class="home_title">Sub-Category : <span class="text-danger"> {{$item->subcategory_name}}</span></h2>
            @endforeach
                        ...
                        <div class="product_grid row">
                            ...
                            <div class="product_item is_new ">
                                ...
                                <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                    <img src="{{ asset($pro->image_one) }}" style="height: 100px; width: 100px;"></div>
