					...
					<div class="deals">
						...
						<div class="deals_slider_container">
							...
							<div class="owl-carousel owl-theme deals_slider">
										...
										<div class="deals_content">
											<div class="deals_info_line d-flex flex-row justify-content-start">
												...
												@if($hot->discount_price != NULL)
													<div class="deals_item_price_a ml-auto">$ <del>{{ $hot->selling_price }}</del></div>
												@endif
											</div>
											<div class="deals_info_line d-flex flex-row justify-content-start">
								...
								<!-- Deals Item -->
								{{-- <div class="owl-item deals_item">
									<div class="deals_image"><img src="{{asset('frontend/images/adv_1.png')}}" alt=""></div>
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
								...
								<!-- Deals Item -->
								{{-- <div class="owl-item deals_item">
									<div class="deals_image"><img src="{{asset('frontend/images/adv_2.png')}}" alt=""></div>
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_category"><a href="#">Headphones</a></div>
											<div class="deals_item_price_a ml-auto">$300</div>
				...
				<!-- ################ Right Column ########### -->	
					...
					<div class="featured">
						<div class="tabbed_container">
							...
							<!-- Product Panel -  New Featured-->
							<div class="product_panel panel active">
								<div class="featured_slider slider">

									@foreach($new_featured as $featured) 
										...
										<div class="featured_slider_item">
											...
											<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
												<div class="product_image d-flex flex-column align-items-center justify-content-center">
													<img src="{{ asset($featured->image_one) }}" style="height: 120px; width: 130px;">
												</div>
												
												<div class="product_content">
													@if($featured->discount_price == NULL)
														<br><span class="text-danger"><b> ${{ $featured->selling_price }} </b></span>
													@else
													...
													<div class="product_extras">
														...
														<button id="{{ $featured->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal"  onclick="productview(this.id)">Add to Cart</button>
													</div>
												</div>
												<!--Without Ajax-->
												{{-- <a href="{{route('wishlist.add',$featured->id)}}">
													<div class="product_fav"><i class="fas fa-heart text-info"></i></div>
												</a> --}} 
												<!--With Ajax-->
												<button  class="addwishlist" data-id="{{ $featured->id }}"> 
							...
							@foreach ($brands as $item)
								<div class="owl-item">
									<div class="popular_category d-flex flex-column align-items-center justify-content-center">
										<div class="popular_category_image"><img src="{{asset($item->brand_logo)}}" alt=""></div>
										<div class="popular_category_text">{{$item->brand_name}}</div>
									</div>
								</div>	
							@endforeach
								...
								<div class="row fill_height">
									<div class="col-lg-4 col-md-6 fill_height">
										<div class="banner_2_content">
											...
											<div class="banner_2_text">{{ $item->brand_name }} <br>Product Id: {{ $item->product_code }}.</div>
									...
									<div class="col-lg-8 col-md-6 fill_height">
										<div class="banner_2_image_container">
											<div class="banner_2_image"><img src="{{ asset($item->image_one) }}" style="height: 300px; width: 320px;" alt=""></div>
										</div>
									</div>
								</div>
							</div>			
					...
					<div class="banner_2_item">
						<div class="container fill_height">
							<div class="row fill_height">
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"><img src="{{asset('frontend/images/banner_product.png')}}" alt=""></div>
									</div>
								</div>
							</div>
						</div>			
									...
									<div class="arrivals_slider slider">
										@foreach($trends as $item)
											...
											<div class="featured_slider_item">
												<div class="border_active"></div>
												<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
													<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($item->image_one) }}" style="height: 120px; width: 130px;"></div>
													<div class="product_content">
...
@endphp
	...
	<!-- By One Get One ||| Here Not use Modal-->
										...
										<div class="trends_content">
											<div class="trends_info clearfix">
												...
												@else
													<div class="product_price discount">${{ $row->discount_price }}<span>$ <del>{{ $row->selling_price }}</del></span></div>
												@endif
													<div><button data-id="{{ $row->id }}" class="btn btn-danger btn-sm pull-right addcard">Add to Cart</button></div>
													{{-- <div><button id="{{ $row->id }}" class="btn btn-info btn-sm pull-right" data-toggle="modal" data-target="#cartmodal"  onclick="productview(this.id)">Add to Cart</button></div> --}}
											</div>
	...
	<!--addcard ||| It's no need because we use Modal in bellow-->
	<script type="text/javascript">
		$(document).ready(function() {
		...
		<div class="modal-body">
		 <div class="row">
			...
			<div class="col-md-4 ml-auto">
				<ul class="list-group">
					<li class="list-group-item">Product Name: <h5 class="card-title" id="pname"></h5></span></li>
